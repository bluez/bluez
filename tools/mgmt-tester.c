...
static const char add_uuid16_param[] = {
...
static const struct generic_data add_uuid16_param_test_1 = {
	.send_opcode = MGMT_OP_ADD_UUID,
	.send_param = add_uuid16_param,
	.send_len = sizeof(add_uuid16_param),
	.expect_status = MGMT_STATUS_SUCCESS,
	.expect_param = set_dev_class_zero_rsp,
	.expect_len = sizeof(set_dev_class_zero_rsp),
...
static const struct generic_data add_uuid32_param_test_1 = {
	.send_opcode = MGMT_OP_ADD_UUID,
...
int main(int argc, char *argv[])
{
	...
	test_bredr("Add UUID - UUID-16 1", &add_uuid16_param_test_1,
				setup_ssp, test_command_generic);
	test_bredr_timeout("Add UUID - UUID-32 1", &add_uuid32_param_test_1,
